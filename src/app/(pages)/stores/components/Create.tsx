...
import { createNewStore, editStore } from '../actions';
...
const CreateButton = () => {
  ...
  const [state, formAction, loading] = useActionState(createNewStore, {
    error: false,
    message: '',
  });
  ...
  return (
    <>
      <button
        ...
        className="items-center flex gap-2 rounded-sm bg-green-600 hover:opacity-90 hover:ring-2 hover:ring-green-600 transition duration-200 delay-300 hover:text-opacity-100 text-white py-2 px-3 w-full"
      >
        <svg
