    ...
    <>
      <div className="flex flex-col justify-center min-h-[100vh] items-center align-middle">
        ...
        <div className="flex flex-row gap-3">
          ...
          <button
            className="bg-blue-500 rounded-md hover:opacity-90 hover:ring-4 hover:ring-primary transition duration-200 delay-300 hover:text-opacity-100 text-white px-4 py-2"
