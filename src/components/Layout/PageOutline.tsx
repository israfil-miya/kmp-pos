      ...
      <div className="flex flex-col h-screen">
        <div className="flex flex-grow">
          ...
          <div className="flex-grow">
            <header className="w-full px-10 py-2 bg-gray-800 text-white flex flex-row justify-between items-center shadow-[0_4px_6px_rgba(0,0,0,0.06)]">
              {/* <div className="flex gap-2 items-center p-4 bg-yellow-400 bg-opacity-30 text-xl font-semibold rounded-sm">
